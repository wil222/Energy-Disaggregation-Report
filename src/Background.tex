...
Also, no capacitor is ideal, there are equivalent series resistance (\acrshort{esr}) and inductance (\acrshort{esl}) used to represent it. When current goes trough the \acrshort{esr}, there is a voltage drop delayed by the inductance. %TODO is that true ? 
